...
class ZeroconfScanner(BaseScanner):
    ...
    async def _async_models_by_name(
        ...
        _LOGGER.warning("Probing _async_models_by_name: %s with timeout %s", names, zc_timeout)
    ...
    def _async_process_responses(
        ...
        _LOGGER.warning("Probing _async_process_responses: %s %s %s", atv_services_by_address, name_to_model, name_by_address)
