...
class ContentItemMetadata(google___protobuf___message___Message):
    ...
    AudioBook = typing___cast('ContentItemMetadata.MediaSubType', 5)
    ITunesU = typing___cast('ContentItemMetadata.MediaSubType', 6)
    global___MediaSubType = MediaSubType
    ...
    mediaType = ... # type: global___ContentItemMetadata.MediaType
    mediaSubType = ... # type: global___ContentItemMetadata.MediaSubType
    ...
    def __init__(self,
        *,
        ...
        mediaType : typing___Optional[global___ContentItemMetadata.MediaType] = None,
        mediaSubType : typing___Optional[global___ContentItemMetadata.MediaSubType] = None,
