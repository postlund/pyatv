...
class SetNowPlayingClientMessage(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SetNowPlayingClientMessage: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SetNowPlayingClientMessage: ...
...
setNowPlayingClientMessage = ... # type: google___protobuf___descriptor___FieldDescriptor
