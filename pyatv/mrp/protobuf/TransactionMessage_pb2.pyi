...
class TransactionMessage(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> TransactionMessage: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"name",u"packets"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"name",u"packets"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"name",b"name",u"packets",b"packets"]) -> bool: ...
