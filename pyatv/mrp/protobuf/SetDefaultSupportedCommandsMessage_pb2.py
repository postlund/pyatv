...
_SETDEFAULTSUPPORTEDCOMMANDSMESSAGE.fields_by_name['nowPlayingInfo'].message_type = pyatv_dot_mrp_dot_protobuf_dot_NowPlayingInfo__pb2._NOWPLAYINGINFO
...
_SETDEFAULTSUPPORTEDCOMMANDSMESSAGE.fields_by_name['playbackQueue'].message_type = pyatv_dot_mrp_dot_protobuf_dot_PlaybackQueue__pb2._PLAYBACKQUEUE
_SETDEFAULTSUPPORTEDCOMMANDSMESSAGE.fields_by_name['playbackState'].enum_type = pyatv_dot_mrp_dot_protobuf_dot_Common__pb2._PLAYBACKSTATE_ENUM
_SETDEFAULTSUPPORTEDCOMMANDSMESSAGE.fields_by_name['playbackQueueCapabilities'].message_type = pyatv_dot_mrp_dot_protobuf_dot_PlaybackQueueCapabilities__pb2._PLAYBACKQUEUECAPABILITIES
_SETDEFAULTSUPPORTEDCOMMANDSMESSAGE.fields_by_name['playerPath'].message_type = pyatv_dot_mrp_dot_protobuf_dot_PlayerPath__pb2._PLAYERPATH
_SETDEFAULTSUPPORTEDCOMMANDSMESSAGE.fields_by_name['request'].message_type = pyatv_dot_mrp_dot_protobuf_dot_PlaybackQueueRequestMessage__pb2._PLAYBACKQUEUEREQUESTMESSAGE
