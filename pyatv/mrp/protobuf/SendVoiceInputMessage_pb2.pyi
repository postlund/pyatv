...
class AudioBuffer(google___protobuf___message___Message):
    ...
    @property
    def packetDescriptions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___AudioStreamPacketDescription]: ...
    ...
    def __init__(self,
        *,
        ...
        packetDescriptions : typing___Optional[typing___Iterable[global___AudioStreamPacketDescription]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
...
class AudioDataBlock(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        buffer : typing___Optional[global___AudioBuffer] = None,
        time : typing___Optional[global___AudioTime] = None,
...
class SendVoiceInputMessage(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        dataBlock : typing___Optional[global___AudioDataBlock] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
