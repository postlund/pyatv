...
_PROTOCOLMESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_NOW_PLAYING_CLIENT_MESSAGE', index=37, number=50,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
