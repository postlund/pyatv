...
_PROTOCOLMESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_NOW_PLAYING_CLIENT_MESSAGE', index=37, number=46,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_CLIENT_MESSAGE', index=38, number=55,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_CONTENT_ITEM_MESSAGE', index=39, number=56,
      serialized_options=None,
      type=None),
  ],
