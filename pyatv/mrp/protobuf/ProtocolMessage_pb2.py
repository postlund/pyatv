...
_PROTOCOLMESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_DEFAULT_SUPPORTED_COMMANDS_MESSAGE', index=54, number=72,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_DISCOVERY_MODE_MESSAGE', index=55, number=101,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_END_POINTS_MESSAGE', index=56, number=102,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REMOVE_ENDPOINTS_MESSAGE', index=57, number=103,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PLAYER_CLIENT_PROPERTIES_MESSAGE', index=58, number=104,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ORIGIN_CLIENT_PROPERTIES_MESSAGE', index=59, number=105,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUDIO_FADE_MESSAGE', index=60, number=106,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AUDIO_FADE_RESPONSE_MESSAGE', index=61, number=107,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
