...
class SendPackedVirtualTouchEventMessage(google___protobuf___message___Message):
    ...
    class Phase(int):
        ...
        @classmethod
        def Value(cls, name: str) -> SendPackedVirtualTouchEventMessage.Phase: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[SendPackedVirtualTouchEventMessage.Phase]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, SendPackedVirtualTouchEventMessage.Phase]]: ...
    ...
    @classmethod
    def FromString(cls, s: bytes) -> SendPackedVirtualTouchEventMessage: ...
