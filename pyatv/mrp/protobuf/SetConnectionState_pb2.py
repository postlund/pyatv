...
# source: pyatv/mrp/protobuf/SetConnectionState.proto
...
SetConnectionStateMessage = _reflection.GeneratedProtocolMessageType('SetConnectionStateMessage', (_message.Message,), dict(
  ...
  __module__ = 'pyatv.mrp.protobuf.SetConnectionState_pb2'
