...
import pyatv.mrp.protobuf.CommandInfo_pb2
import pyatv.mrp.protobuf.CommandOptions_pb2
...
class SendCommandMessage(google.protobuf.message.Message):
    ...
    command: pyatv.mrp.protobuf.CommandInfo_pb2.Command.V = ...

    @property
    def options(self) -> pyatv.mrp.protobuf.CommandOptions_pb2.CommandOptions: ...
    ...
    def __init__(self,
        *,
        command : typing.Optional[pyatv.mrp.protobuf.CommandInfo_pb2.Command.V] = ...,
        options : typing.Optional[pyatv.mrp.protobuf.CommandOptions_pb2.CommandOptions] = ...,
...
sendCommandMessage: google.protobuf.descriptor.FieldDescriptor = ...
