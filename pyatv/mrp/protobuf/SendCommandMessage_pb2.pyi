...
class SendCommandMessage(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> SendCommandMessage: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"command",u"options",u"playerPath"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"command",u"options",u"playerPath"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"command",b"command",u"options",b"options",u"playerPath",b"playerPath"]) -> bool: ...
