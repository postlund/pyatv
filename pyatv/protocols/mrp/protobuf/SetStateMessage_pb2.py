...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pyatv/protocols/mrp/protobuf/SetStateMessage.proto',
  package='',
  syntax='proto2',
...
_SETSTATEMESSAGE.fields_by_name['nowPlayingInfo'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_NowPlayingInfo__pb2._NOWPLAYINGINFO
_SETSTATEMESSAGE.fields_by_name['supportedCommands'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_SupportedCommands__pb2._SUPPORTEDCOMMANDS
_SETSTATEMESSAGE.fields_by_name['playbackQueue'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_PlaybackQueue__pb2._PLAYBACKQUEUE
_SETSTATEMESSAGE.fields_by_name['playbackState'].enum_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_Common__pb2._PLAYBACKSTATE_ENUM
_SETSTATEMESSAGE.fields_by_name['playbackQueueCapabilities'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_PlaybackQueueCapabilities__pb2._PLAYBACKQUEUECAPABILITIES
_SETSTATEMESSAGE.fields_by_name['playerPath'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_PlayerPath__pb2._PLAYERPATH
_SETSTATEMESSAGE.fields_by_name['request'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_PlaybackQueueRequestMessage__pb2._PLAYBACKQUEUEREQUESTMESSAGE
...
SetStateMessage = _reflection.GeneratedProtocolMessageType('SetStateMessage', (_message.Message,), {
  ...
  '__module__' : 'pyatv.protocols.mrp.protobuf.SetStateMessage_pb2'
...
pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_ProtocolMessage__pb2.ProtocolMessage.RegisterExtension(setStateMessage)
