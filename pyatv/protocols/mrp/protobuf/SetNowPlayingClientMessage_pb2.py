...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pyatv/protocols/mrp/protobuf/SetNowPlayingClientMessage.proto',
  package='',
  syntax='proto2',
...
_SETNOWPLAYINGCLIENTMESSAGE.fields_by_name['client'].message_type = pyatv_dot_protocols_dot_mrp_dot_protobuf_dot_NowPlayingClient__pb2._NOWPLAYINGCLIENT
