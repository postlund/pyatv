...
class AudioFormatSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"formatSettingsPlistData",b"formatSettingsPlistData"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"formatSettingsPlistData",b"formatSettingsPlistData"]) -> None: ...
